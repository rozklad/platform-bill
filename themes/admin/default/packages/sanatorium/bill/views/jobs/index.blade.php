...
@section('title')
@parent
{{ trans('sanatorium/bill::jobs/common.title') }}
@stop
...
{{ Asset::queue('index', 'sanatorium/bill::jobs/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('sanatorium/bill::jobs/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.sanatorium.bill.jobs.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="job" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="job" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="job" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="job" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="job"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.sanatorium.bill.jobs.grid') }}" data-grid="job">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="id">{{{ trans('sanatorium/bill::jobs/model.general.id') }}}</th>
					<th class="sortable" data-sort="bill_id">{{{ trans('sanatorium/bill::jobs/model.general.bill_id') }}}</th>
					<th class="sortable" data-sort="quantity">{{{ trans('sanatorium/bill::jobs/model.general.quantity') }}}</th>
					<th class="sortable" data-sort="description">{{{ trans('sanatorium/bill::jobs/model.general.description') }}}</th>
					<th class="sortable" data-sort="price">{{{ trans('sanatorium/bill::jobs/model.general.price') }}}</th>
					<th class="sortable" data-sort="currency">{{{ trans('sanatorium/bill::jobs/model.general.currency') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('sanatorium/bill::jobs/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="job"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('sanatorium/bill::jobs/grid/index/results')
	@include('sanatorium/bill::jobs/grid/index/pagination')
	@include('sanatorium/bill::jobs/grid/index/filters')
	@include('sanatorium/bill::jobs/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('sanatorium/bill::jobs/help')
@endif
