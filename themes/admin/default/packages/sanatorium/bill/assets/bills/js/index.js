...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'bill');

		$('.daterangepicker_end_input').attr('data-grid', 'bill');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('bill', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
