...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'job');

		$('.daterangepicker_end_input').attr('data-grid', 'job');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('job', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
